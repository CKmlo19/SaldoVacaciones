...
-- Para TipoEvento
CREATE TABLE #TempTipoEvento (
	Id INT,
    Nombre VARCHAR(64),
);

-- Para tipoMovimiento
CREATE TABLE #TempTipoMovimiento(
	Id INT,
    Nombre VARCHAR(64),
...
-- Al final se borran todas las tablas temporales
DROP TABLE #TempEmpleados;
DROP TABLE #TempPuesto;
DROP TABLE #TempUsuario;
DROP TABLE #TempTipoEvento;
DROP TABLE #TempTipoMovimiento
